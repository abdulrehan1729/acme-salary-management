import { AppBar, Box, Button, Container, CssBaseline, Tab, Tabs, ThemeProvider, Toolbar, Typography, createTheme } from "@mui/material";
...
function NavTabs() {
  ...
  return (
    <Tabs value={current} onChange={(_e, value) => navigate(value)} textColor="inherit" indicatorColor="secondary" sx={{ flexGrow: 1, ml: 4 }}>
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        <Routes>
          <Route path="/" element={<div>Employee directory — coming in Step 11</div>} />
          <Route path="/employees/new" element={<div>New employee form — coming later</div>} />
          <Route path="/employees/:id" element={<div>Employee detail — coming later</div>} />
