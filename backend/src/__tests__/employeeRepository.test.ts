...
describe("EmployeeRepository", () => {
  ...
  describe("findMany — filtering", () => {
    beforeEach(() => {
      repo.insert(sampleEmployee({ employee_code: "EMP-000001", email: "eng-us@acme.com", department: "Engineering", country: "US" }));
      repo.insert(sampleEmployee({ employee_code: "EMP-000002", email: "eng-gb@acme.com", department: "Engineering", country: "GB" }));
      repo.insert(sampleEmployee({ employee_code: "EMP-000003", email: "sales-us@acme.com", department: "Sales", country: "US" }));
    });
  ...
  describe("findMany — pagination", () => {
    beforeEach(() => {
      for (let i = 1; i <= 5; i++) {
        repo.insert(sampleEmployee({ employee_code: `EMP-00000${i}`, email: `p${i}@acme.com`, last_name: `Person${i}` }));
      }
    });
