...
export class EmployeeRepository {
    ...
    private findAllActiveStmt: Statement;
    ...
    constructor(private db: Database.Database) {
      ...
      @base_salary_annual, @base_salary_annual_usd
        ...
        this.findAllActiveStmt = db.prepare("SELECT * FROM employees WHERE status = 'ACTIVE'");
        this.nextCodeStmt = db.prepare("SELECT employee_code FROM employees ORDER BY employee_code DESC LIMIT 1");
    ...
    findAllActive(): EmployeeRow[] {
        return this.findAllActiveStmt.all() as EmployeeRow[];
    }
    ...
    update(id: string, patch: Partial<Omit<EmployeeRow, "id" | "created_at" | "updated_at">>): EmployeeRow | undefined {
